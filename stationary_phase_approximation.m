...
for x=1:N
    ...
    [tt_single_boundary,qq_single_boundary] = ode45(@(t,q) velocity_single_electron(abs(phiMinus(t,q,theta_el,alpha_el,k_el,0,omega,step)).^2,abs(phiPlus(t,q,theta_el,alpha_el,k_el,0,omega,step)).^2),times,q0(2)-mu_el);
